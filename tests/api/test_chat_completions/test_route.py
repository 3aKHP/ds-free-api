...
class TestChatCompletionsRoute:
    def test_non_streaming_respects_search_enabled(self, client, monkeypatch):
        ...
        async def fake_stream_generator(prompt, model_name, search_enabled, thinking_enabled, tools, session, model_type="default"):
    ...
    def test_non_streaming_empty_chunks_returns_502(self, client, monkeypatch):
        ...
        async def empty_stream_generator(prompt, model_name, search_enabled, thinking_enabled, tools, session, model_type="default"):
            if False:
                yield None
